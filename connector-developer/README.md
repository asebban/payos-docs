...
- [configuration/connector-framework-parameters-v2-2026-07-12.md](../configuration/connector-framework-parameters-v2-2026-07-12.md) — the full operator-facing configuration reference (`connectors.json`, API-version compatibility policy, retry/DLQ parameters, diagnostics) for whoever deploys your connector.

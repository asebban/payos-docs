...
- [getting-started-v1-2026-09-07.md](getting-started-v1-2026-09-07.md) — where this page's descriptor/SPI/`connectors.json` steps fit into the full path from an empty directory.

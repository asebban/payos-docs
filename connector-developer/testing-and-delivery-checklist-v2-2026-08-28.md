...
- Every bundled third-party (non-`ma.s2m.payos`) library is on the approved dependencies registry (see [external-dependency-approval-v4-2026-08-28.md §4](external-dependency-approval-v4-2026-08-28.md#4-the-approved-dependencies-registry)) — request approval before delivery if it isn't.
...
- [external-dependency-approval-v4-2026-08-28.md](external-dependency-approval-v4-2026-08-28.md) — how to get a bundled third-party library approved before delivery.

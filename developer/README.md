...
13. [Event category payload contracts (v2, 2026-07-12)](./event-category-payload-contracts-v2-2026-07-12.md) - one abstraction per event category (audit, analytics, event-sourcing, metrics, integration, connector retry/DLQ diagnostics); supersedes the older [single-envelope observability proposal](./observability-event-contract-proposal.md)

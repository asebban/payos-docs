...
- [configuration/connector-framework-parameters-v3-2026-08-11.md](../configuration/connector-framework-parameters-v3-2026-08-11.md) — référence de configuration complète (`connectors.json`, compatibilité de version d'API, politiques de retry/DLQ, diagnostics).
